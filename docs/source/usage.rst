...
The GNNgraph is approach convoluted and recursive in nature; it's fundamentally autodidactic. It involves several steps, but, of course, these steps are mallable. We believe that the most important step might be the fourth step of using documentation to add/attract autodidactive collaborators ... but each of these steps is necessarily about stimulating collaboration:
