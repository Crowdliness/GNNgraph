...
Crowdliness is autodiadictism raised to a higher power. The GNNgraph is approach convoluted and recursive in nature; it involves several steps ... the most important step might be the fourth step of using documentation to add/attract collaborators ... but all steps are about collaboration:
